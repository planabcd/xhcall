...
//			queryFee("15号楼","东门");
	...
	public void queryFee(final String from,final String to) {
		...
		String queryUrl = Constant.TIME_QUERY_ALL + "?from="+from+"&to="+to;
		...
		httpUtils.send(HttpMethod.GET, queryUrl,new RequestCallBack<String>() {
			...
			public void onSuccess(ResponseInfo<String> responseInfo) {
				...
				if(TextUtils.isEmpty(result)){
					...
					/*new SweetAlertDialog(TimeActivity.this, SweetAlertDialog.CUSTOM_IMAGE_TYPE)
                    .setTitleText(from+"---"+to)
                    .setContentText("Total: "+result+" 分钟")
                    .show();*/
					
					new SweetAlertDialog(TimeActivity.this, SweetAlertDialog.SUCCESS_TYPE)
                    .setTitleText(from+"---"+to)
                    .setContentText("Total: "+result+" 分钟")
                    .show();
				}
