...
public class StationActivity extends Activity{
	...
	public void queryStation(String to) {
		pb_route_query.setVisibility(View.VISIBLE);
//		to = "东门";
		String queryUrl = Constant.ROUTE_QUERY_ALL + "?from="+to+"&to="+to;
	...
	class MyAdapter extends BaseAdapter{
		...
		public View getView(final int position, View convertView, ViewGroup parent) {
			...
			View view = View.inflate(StationActivity.this,R.layout.list_item_route, null);
			...
			rl_item_route.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					...
					new SweetAlertDialog(StationActivity.this, SweetAlertDialog.CUSTOM_IMAGE_TYPE)
